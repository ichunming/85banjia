package com.ichunming.banjia.core.interceptor;
...
import com.ichunming.banjia.constant.SystemSettings;
import com.ichunming.banjia.core.helper.AgentHelper;
import com.ichunming.banjia.entity.BanjiaSessionInfo;
...
public class SecurityInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		if(SystemSettings.DEBUG_MODE) {
			sessionInfo = new BanjiaSessionInfo("0", "test", null);
